...
from app.api.service_auth_api.schemas.users import UserPublic
from app.api.service_auth_api.models.tokens import Token
...
def get_current_user(db: Session = Depends(get_db), token: str = Depends(reusable_oauth2)) -> UserPublic:
    """
