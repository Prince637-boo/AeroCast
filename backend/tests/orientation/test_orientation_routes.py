...
class TestOrientationAPI:
    ...
    async def test_post_orientation(self, client):
        ...
        with patch('services.orientation.routers.orientation.get_meteo_client'), \
             patch('services.orientation.routers.orientation.get_bagage_client'), \
             patch('services.orientation.routers.orientation.get_vol_client'):
